...
export default function ItemsList() {
  ...
  const experiences = data.experiences.edges.map(item => (
    <li
      key={item.node.frontmatter.title} className="experiences"
    >
      <button
        className="popupWindowLinkButton"
        style={{ cursor: "pointer"}}
  ...
  const experiencesMobile = data.experiences.edges.map(item => (
    <li
      key={item.node.frontmatter.title} className="experiences"
    >
      <Link
  ...
  const mappedItems = () => {
    return (
      <>
        ...
        <li className="experiences">→ Professional Experiences:</li> {experiences}
        <li>→ Projects:</li>
  ...
  const mappedItemsMobile = () => {
    return (
      <>
        ...
        <li>→ Professional Experiences:</li> {experiencesMobile}{" "}
